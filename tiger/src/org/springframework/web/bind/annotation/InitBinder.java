...
public @interface InitBinder {
	...
	/**
	 * The names of command/form attributes that this init-binder method
	 * is supposed to apply to.
	 * <p>Default is to apply to all command/form attributes used by
	 * the annotated handler class. Specifying model attribute names here
	 * restricts the init-binder method to those specific model attributes,
	 * with different init-binder methods applying to different attributes.
	 */
